...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setupSquadButtons(view);
        updateThemeButtonsUI(currentThemeMode, view);
        updateSquadButtonsUI(getView());
    ...
    private void initViews(View view, Bundle savedInstanceState) {
        textCoords = view.findViewById(R.id.textCoords);
        textCallsign = view.findViewById(R.id.textCallsign);
        ...
        textLinkStatus = view.findViewById(R.id.textLinkStatus);
        viewStatusIndicator = view.findViewById(R.id.viewStatusIndicator);
        textRangeBearing = view.findViewById(R.id.textRangeBearing);
        btnExportSession = view.findViewById(R.id.btnExportSession);
        ...
        btnMapOrientation = view.findViewById(R.id.btnMapOrientation);
        btnMapOrientation.setOnClickListener(v -> toggleMapOrientation());
        updateMapOrientationUI();

        bannerEmergency = view.findViewById(R.id.bannerEmergency);
        textEmergencyTitle = view.findViewById(R.id.textEmergencyTitle);
        ...
        btnUnit1001 = view.findViewById(R.id.btnUnit1001);
        btnUnit1002 = view.findViewById(R.id.btnUnit1002);
        btnUnit1003 = view.findViewById(R.id.btnUnit1003);

        view.findViewById(R.id.panelTelemetry).setOnClickListener(v -> snapCameraToActiveUnit());

        mapView = view.findViewById(R.id.mapView);
        mapView.onCreate(savedInstanceState);
    }

    private void setupSquadButtons(View view) {
    ...
    private void updateSquadButtonsUI(View view) {
    ...
    private void setupThemeButtons(View view) {
        view.findViewById(R.id.btnThemeDay).setOnClickListener(v -> switchTheme(THEME_DAY));
        view.findViewById(R.id.btnThemeInstrument).setOnClickListener(v -> switchTheme(THEME_INSTRUMENT));
        view.findViewById(R.id.btnThemeBlackout).setOnClickListener(v -> switchTheme(THEME_BLACKOUT));
    }

    private void updateThemeButtonsUI(int activeMode, View view) {
        int inkColor = resolveThemeColor(R.attr.appInk);
        int surfaceColor = resolveThemeColor(R.attr.appSurface);
        int bgColor = resolveThemeColor(R.attr.appBg);

        applyButtonStyle(view.findViewById(R.id.btnThemeDay), activeMode == THEME_DAY, inkColor, surfaceColor, bgColor, inkColor);
        applyButtonStyle(view.findViewById(R.id.btnThemeInstrument), activeMode == THEME_INSTRUMENT, inkColor, surfaceColor, bgColor, inkColor);
        applyButtonStyle(view.findViewById(R.id.btnThemeBlackout), activeMode == THEME_BLACKOUT, inkColor, surfaceColor, bgColor, inkColor);
    }
    ...
    private int resolveThemeColor(int attrResId) {
        ...
        if (requireActivity().getTheme().resolveAttribute(attrResId, typedValue, true)) {
